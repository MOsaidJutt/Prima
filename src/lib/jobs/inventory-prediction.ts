...
export async function runPredictionForOrg(orgId: string) {
...
/** Runs demand prediction for every AI-enabled org, isolating per-org failures. */
export async function runInventoryPredictions(): Promise<void> {
