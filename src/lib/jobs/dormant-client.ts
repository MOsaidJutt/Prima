...
export async function runDormantClientDetection(orgId: string) {
...
/** Runs dormant-client detection for every AI-enabled org, isolating per-org failures. */
export async function runDormantClientDetectionAll(): Promise<void> {
